...
object oSpawn;
location lTarget;
oTarget = GetWaypointByTag("tempazmodan");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_PLACEABLE, "kingportal005", lTarget);
...
oTarget = GetWaypointByTag("outazmodan");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_CREATURE, "azmodan100", lTarget);
