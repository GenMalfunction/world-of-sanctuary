...
object oSpawn;
location lTarget;
oTarget = GetWaypointByTag("tempcain");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_PLACEABLE, "kingportal009", lTarget);
...
oTarget = GetWaypointByTag("outcain");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_CREATURE, "cain100", lTarget);
