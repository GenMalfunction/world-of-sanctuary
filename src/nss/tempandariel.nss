...
object oSpawn;
location lTarget;
oTarget = GetWaypointByTag("tempandariel");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_PLACEABLE, "kingportal004", lTarget);
...
oTarget = GetWaypointByTag("outandariel");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_CREATURE, "guguaruva001", lTarget);
