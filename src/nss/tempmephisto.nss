...
object oSpawn;
location lTarget;
oTarget = GetWaypointByTag("tempmephisto");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_PLACEABLE, "kingportal013", lTarget);
...
oTarget = GetWaypointByTag("outmephisto");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_CREATURE, "mephisto100", lTarget);
