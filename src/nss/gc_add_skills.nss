...
int nSkill = GetLocalInt(oPC, "CRAFT_SKILL");
int nPts = GetLocalInt(oPC, "CRAFT_SKIL_PTS");

//What we are adding is AC
itemproperty ipAddAC=ItemPropertySkillBonus(nSkill, nPts);
