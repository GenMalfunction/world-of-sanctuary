...
object oSpawn;
location lTarget;
oTarget = GetWaypointByTag("tempking");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_PLACEABLE, "kingportal014", lTarget);
...
oTarget = GetWaypointByTag("outking");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_CREATURE, "king100", lTarget);
