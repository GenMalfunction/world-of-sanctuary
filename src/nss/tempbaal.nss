...
object oSpawn;
location lTarget;
oTarget = GetWaypointByTag("tempbaal");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_PLACEABLE, "kingportal006", lTarget);
...
oTarget = GetWaypointByTag("outbaal");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_CREATURE, "baal100", lTarget);
