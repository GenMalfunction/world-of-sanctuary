//::**********************************************
//:: Script: pgs_disp_fac_gld
//:: Player Guild System - Version 4.x
//::**********************************************
/*
        This script will display guild-related
    information for the faction sender's guild.
*/
//::**********************************************
...
{
    int iGuild = PGS_GetPlayerInt (GetLocalObject (GetPCSpeaker(),
        "PGS_Journal_Activator"), PGS_GUILD_NUMBER);
