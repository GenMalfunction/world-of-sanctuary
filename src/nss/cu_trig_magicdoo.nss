...
void main()
{
    ...
    object oDoor = GetObjectByTag("DwarfDoor");
...
//    object oSounder = GetObjectByTag( "NoiseRock");
    ...
    if (GetLocalInt(oTarget, "nSeenDwarfDoor")==0)
    {
        AddJournalQuestEntry("[Side Quest] The Old Stone Door", 2, oTarget);
    }
...
//    SoundObjectPlay(oSounder);
    ...
    {
    PartyGotEntry(sObjectTag,oTarget,5000, "XP gain - furthered plot");
    }
