...
itemproperty ipAddAC=ItemPropertyTrueSeeing();

//Remove the Existing FIRST!
IPRemoveMatchingItemProperties(oCraft, ITEM_PROPERTY_TRUE_SEEING, DURATION_TYPE_PERMANENT, -1);
