...
//Vampiric Regen is VERY Powerful let's dbl the cost!
int nMult = GetLocalInt(oPC, "CRAFT_PAYMENT");
int nCost = nMult*2;
...
itemproperty ipAddAC=ItemPropertyVampiricRegeneration(nBonus);

//Remove the Existing FIRST!
IPRemoveMatchingItemProperties(oCraft, ITEM_PROPERTY_REGENERATION_VAMPIRIC, DURATION_TYPE_PERMANENT, -1);
