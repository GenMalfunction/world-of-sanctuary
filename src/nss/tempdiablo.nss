...
object oSpawn;
location lTarget;
oTarget = GetWaypointByTag("tempdiablo");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_PLACEABLE, "kingportal010", lTarget);
...
oTarget = GetWaypointByTag("outdiablo");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_CREATURE, "diablo100", lTarget);
