...
// * tweaking constants
    ...
    float LOW_MOD_GOLD = 1.0;   float MEDIUM_MOD_GOLD = 2.0; float HIGH_MOD_GOLD = 3.0;
        ...
        void CreateSpecificMonkWeapon(object oTarget, object oAdventurer, int nModifier = 0)
        {
            ...
            else  // * 16000 +
            {
                  ...
                  switch (nRandom)
                  {
                       ...
                       case 16: sItem = "nw_wbwmsl007"; break;
        ...
        void CreateSpecificDruidWeapon(object oTarget, object oAdventurer, int nModifier = 0)
        {
            ...
            else  // * 16000 +
            {
                  ...
                  switch (nRandom)
                  {
                       ...
                       case 12: sItem = "nw_wbwmsl007"; break;
        ...
        void CreateSpecificMartial(object oTarget, object oAdventurer)
        {
            ...
            else if (GetRange(6, nHD))   // * 16000 and up
            {
                  ...
                  switch (nRandom)
                  {
                       ...
                       case 39: sItem = "nw_wbwmsh004"; break;
                       case 40: sItem = "nw_wbwmsh004"; break;
...
void CreateCustomTreasure(object oTarget)
                {
                /*
                place the res ref of the items you want to dropbetween ""
                for instance "item_i_chose"
                includes the script // #include "x_o2_coninclude" //
                */
                string sItem = "";
                int nRandom = Random(90) + 1;
                switch (nRandom)
                {
                  case 1: sItem = "nomadplate"; break;          // nomad plate
                 case 2: sItem = "nomadblade"; break;           // nomad Blade (set) (1-3)
                 case 3: sItem = "nomadburka"; break;           // the nomad burka (set) (2-3)
                 case 4: sItem = "greaterfighter"; break;       // Greater fighter duds
                 case 5: sItem = "alberichcasque"; break;       // alberich's helm (set)
                 case 6: sItem = "hagenhelm2"; break;           // Hagen Helm  (set) (1-5)
                 case 7: sItem = "nw_it_mboots002"; break;      // NWN boots
                 case 8: sItem = "kahnsamulet"; break;          // Kahn's amulet
                 case 9: sItem = "hagenboots"; break;           // Hagen boots (set) (3-5)
                 case 10: sItem = "othersling"; break;          // other sling (set) (1-5)
                 case 11: sItem = "divineshelter"; break;       // divine armour (set)(1-3)
                 case 12: sItem = "divinecircle"; break;        // divine belt  (set) (2-3)
                 case 13: sItem = "greatersundayb"; break;      // Greater sundays Best
                 case 14: sItem = "hagencloak"; break;          // Hagen Cloak (set) (4-5)
                 case 15: sItem = "hagensgrip"; break;          // Hagen Gloves (Set) (5-5)
                 case 16: sItem = "helioshelm"; break;          // Helios Helm (Set) (1-4)
                 case 17: sItem = "osirisshelp"; break;         // Osiris help
                 case 18: sItem = "helioscloth2"; break;        // Helios Cloath (Set) (3-4)
                 case 19: sItem = "heliosband"; break;          // Helios Ring (Set) (4-4)
                 case 20: sItem = "isisshelp"; break;           // Other helm (Set) (2-5)
                 case 21: sItem = "otherrobes"; break;          // Other robes (Set) (3-5)
                 case 22: sItem = "otherbelt001"; break;        // Other Belt (Set) (4-5)
                 case 23: sItem = "otherboots001"; break;       // Other boots (Set) (5-5)
                 case 24: sItem = "slice2"; break;              // Slice Axe (the one that Hagen uses)
                 case 25: sItem = "zebraarmour"; break;         // Zebra Armour
                 case 26: sItem = "heartofthetitan"; break;     // TitanSet (Set) (1-6)
                 case 27: sItem = "crownofthetitan"; break;     // TitanSet (Set) (2-6)
                 case 28: sItem = "titanscase"; break;          // TitanSet (Set) (3-6)
                 case 29: sItem = "bloodofthetitan"; break;     // TitanSet (Set) (4-6)
                 case 30: sItem = "tredcarefully"; break;       // TredCarefully
                 case 31: sItem = "bootsofthetitan"; break;     // TitanSet (Set) (6-6)
                 case 32: sItem = "torhelm"; break;             // Tor (Set) (1-5)
                 case 33: sItem = "torshield"; break;           // Tor (Set) (2-5)
                 case 34: sItem = "armoroftor"; break;          // Tor (Set) (3-5)
                 case 35: sItem = "cloakofgreatas"; break;      // Cloak of greater assistance
                 case 36: sItem = "torshield"; break;           // Tor (Set) (5-5)
                 case 37: sItem = "shidoplate"; break;          // Shido (Set) (1-4)
                 case 38: sItem = "shidosintelect"; break;      // Shido (Set) (2-4)
                 case 39: sItem = "shidokatana5"; break;        // Shido (Set) (3-4)
                 case 40: sItem = "shidokatana4"; break;        // Shido (Set) (4-4)
                 case 41: sItem = "sigurdgreatswor"; break;     // Sigurd Set (Set) (1-3)
                 case 42: sItem = "sigurdfullplat"; break;      // Sigurd Set (Set) (2-3)
                 case 43: sItem = "bonusplus"; break;           // Sigurd Set (Set) (3-3)
                 case 44: sItem = "mordleather"; break;         // Mord (Set) (1-2)
                 case 45: sItem = "mordkatana"; break;          // Mord (Set) (2-2)
                 case 46: sItem = "beltofthetitan"; break;      // Belt of the titan (Set)
                 case 47: sItem = "shidoplate"; break;          // Shido (Set) (1-4)
                 case 48: sItem = "shidosintelect"; break;      // Shido (Set) (2-4)
                 case 49: sItem = "apollosward"; break;         // Appollo's Ward
                 case 50: sItem = "shidokatana4"; break;        // Shido (Set) (4-4)
                 case 51: sItem = "sigurdgreatswor"; break;     // Sigurd Set (Set) (1-3)
                 case 52: sItem = "maarcl1105555"; break;       // Rhiannon's Armour (Set) (4-5)
                 case 53: sItem = "it_mbelt0255555"; break;     // Rhiannon's Belt (Set) (3-5)
                 case 54: sItem = "it_mglove0055555"; break;    // Rhiannon's Gloves (Set) (2-5)
                 case 55: sItem = "it_mring0385555"; break;     // Rhiannon's ring (Set) (1-5)
                 case 56: sItem = "seleneshelp"; break;         // Selenes Help (Set)
                 case 57: sItem = "premonitionston"; break;     // Permutition stone
                 case 58: sItem = "epicmagesbane"; break;       // Epics Magebane
                 case 59: sItem = "godlytinderbox"; break;      // Godly thinder box
                 case 60: sItem = "flashofzeus"; break;         // Flash of Zeus
                 case 70: sItem = "glowingrobessel"; break;     // robes of
                 case 71: sItem = "rangersbattle"; break;       // Rangers Batlering
                 case 72: sItem = "elvenringofre"; break;       // Eleven ring of
                 case 73: sItem = "amuletofthego"; break;       // Amulet of the gods
                 case 74: sItem = "odinsgrip"; break;           // Odin's Grip
                 case 75: sItem = "thorsguard"; break;          // Thorsguard (Set) (1-4)
                 case 76: sItem = "safetyhelmet"; break;        // Safety helmet
                 case 77: sItem = "freyasward"; break;          // Freya's ward (Set) (1-3)
                 case 78: sItem = "rroyalrobesof"; break;       // Royal robes of
                 case 79: sItem = "lesserfighters"; break;      // Lesser fighter duds
                 case 80: sItem = "rangersbattle"; break;       // Rangers Batlering
                 case 81: sItem = "eldaraksglove"; break;       // Elderak (Set) (1-6)
                 case 82: sItem = "eldarakscloak"; break;       // Elderak (Set) (2-6)
                 case 83: sItem = "eldaraksboot"; break;        // Elderak (Set) (3-6)
                 case 84: sItem = "eldarakshelm"; break;        // Elderak (Set) (4-6)
                 case 85: sItem = "eldaraksbelt"; break;        // Elderak (Set) (5-6)
                 case 86: sItem = "naturesfriend"; break;       // Elderak (Set) (6-6)
                 case 87: sItem = "drennorsthoughts"; break;    // Drennors Plate (Set) (1-4)
                 case 88: sItem = "drennorsload"; break;        // Drennors Plate (Set) (2-4)
                 case 89: sItem = "drennorsintellec"; break;    // Drennors Plate (Set) (3-4)
                 case 90: sItem = "drennorssoulplat"; break;    // Drennors Plate (Set) (4-4)
                 }
                 dbCreateItemOnObject(sItem, oTarget, 1);
                 }
...
void CreateCustomTreasure2(object oTarget)
                {
                /*
                place the res ref of the items you want to dropbetween ""
                for instance "item_i_chose"
                ...
                */
                string sItem = "";
                int nRandom = Random(80) + 1;
                switch (nRandom)
                {
                 case 1: sItem = "nomadplate"; break;           // nomad plate
                 case 2: sItem = "nomadblade"; break;           // nomad Blade (set) (1-3)
                 case 3: sItem = "nomadburka"; break;           // the nomad burka (set) (2-3)
                 case 4: sItem = "nomadbelt"; break;            // the nomad belt (set)(3-3)
                 case 5: sItem = "alberichcasque"; break;       // alberich's helm (set)
                 case 6: sItem = "hagenhelm2"; break;           // Hagen Helm  (set) (1-5)
                 case 7: sItem = "odinshand"; break;            // Odin's Hand
                 case 8: sItem = "kahnsamulet"; break;          // Kahn's amulet
                 case 9: sItem = "hagenboots"; break;           // Hagen boots (set) (3-5)
                 case 10: sItem = "othersling"; break;          // other sling (set) (1-5)
                 case 11: sItem = "divineshelter"; break;       // divine armour (set)(1-3)
                 case 12: sItem = "divinecircle"; break;        // divine belt  (set) (2-3)
                 case 13: sItem = "hagenfullplate2"; break;     // Hagen full plate (set) (2-5)
                 case 14: sItem = "hagencloak"; break;          // Hagen Cloak (set) (4-5)
                 case 15: sItem = "hagensgrip"; break;          // Hagen Gloves (Set) (5-5)
                 case 16: sItem = "helioshelm"; break;          // Helios Helm (Set) (1-4)
                 case 17: sItem = "heliossleather"; break;      // Helios Leather (Set) (2-4)
                 case 18: sItem = "helioscloth2"; break;        // Helios Cloath (Set) (3-4)
                 case 19: sItem = "heliosband"; break;          // Helios Ring (Set) (4-4)
                 case 20: sItem = "otherhelm"; break;           // Other helm (Set) (2-5)
                 case 21: sItem = "otherrobes"; break;          // Other robes (Set) (3-5)
                 case 22: sItem = "otherbelt001"; break;        // Other Belt (Set) (4-5)
                 case 23: sItem = "otherboots001"; break;       // Other boots (Set) (5-5)
                 case 24: sItem = "slice2"; break;              // Slice Axe (the one that Hagen uses)
                 ...
                 case 28: sItem = "titanscase"; break;          // TitanSet (Set) (3-6)
                 case 29: sItem = "bloodofthetitan"; break;     // TitanSet (Set) (4-6)
                 case 30: sItem = "cloakofthetitan"; break;     // TitanSet (Set) (5-6)
                 case 31: sItem = "bootsofthetitan"; break;     // TitanSet (Set) (6-6)
                 case 32: sItem = "torhelm"; break;             // Tor (Set) (1-5)
                 case 33: sItem = "torshield"; break;           // Tor (Set) (2-5)
                 case 34: sItem = "armoroftor"; break;          // Tor (Set) (3-5)
                 case 35: sItem = "axeofthelegen"; break;       // Tor (Set) (4-5)
                 case 36: sItem = "torshield"; break;           // Tor (Set) (5-5)
                 case 37: sItem = "shidoplate"; break;          // Shido (Set) (1-4)
                 case 38: sItem = "shidosintelect"; break;      // Shido (Set) (2-4)
                 case 39: sItem = "shidokatana5"; break;        // Shido (Set) (3-4)
                 ...
                 case 41: sItem = "sigurdgreatswor"; break;     // Sigurd Set (Set) (1-3)
                 case 42: sItem = "sigurdfullplat"; break;      // Sigurd Set (Set) (2-3)
                 case 43: sItem = "sigurdshelm"; break;         // Sigurd Set (Set) (3-3)
                 case 44: sItem = "mordleather"; break;         // Mord (Set) (1-2)
                 case 45: sItem = "mordkatana"; break;          // Mord (Set) (2-2)
                 case 46: sItem = "torshield"; break;           // Tor (Set) (5-5)
                 case 47: sItem = "shidoplate"; break;          // Shido (Set) (1-4)
                 case 48: sItem = "shidosintelect"; break;      // Shido (Set) (2-4)
                 case 49: sItem = "shidokatana5"; break;        // Shido (Set) (3-4)
                 case 50: sItem = "shidokatana4"; break;        // Shido (Set) (4-4)
                 case 51: sItem = "bracersofmagic"; break;      // Kame-Hame (Set) (1-2)
                 case 52: sItem = "kamehamemagic"; break;       // Kame-Hame (Set) (2-2)
                 case 53: sItem = "greaterlokikat"; break;      // Loki (Set) (1-3)
                 case 54: sItem = "lokisdeception"; break;      // Loki (Set) (2-3)
                 case 55: sItem = "lokiamulet"; break;          // Loki (Set) (3-3)
                 case 56: sItem = "it_mneck0415555"; break;     // Rhiannon's helm (Set) (1-5)
                 case 57: sItem = "maarcl1105555"; break;       // Rhiannon's armour (Set) (2-5)
                 case 58: sItem = "it_mbelt0255555"; break;     // Rhiannon's belt (Set) (3-5)
                 case 59: sItem = "it_mglove0055555"; break;    // Rhiannon's Gloves (Set) (4-5)
                 case 60: sItem = "it_mring0385555"; break;     // Rhiannon's ring (Set) (5-5)
                 case 61: sItem = "greaterpalemast"; break;     // Greater Palemaster robes
                 case 62: sItem = "whiterobeofth"; break;       // Great white robe of the magi
                 case 63: sItem = "cloth006"; break;            // ?????
                 case 64: sItem = "doombringer"; break;         // Doombringer Greatsword
                 case 65: sItem = "ultimatedesire"; break;      // Ultimate Desire longsword
                 case 66: sItem = "dancingbladeof"; break;      // Dancing Blade of Death
                 case 67: sItem = "drainer10"; break;           // Drainer Sword +10
                 case 68: sItem = "fenrirrapier"; break;        // Fenrir (Set) (1-3)
                 case 69: sItem = "fenrirscimitar"; break;      // Fenrir (Set) (2-3)
                 case 70: sItem = "fenrircloath1"; break;       // Fenrir (Set) (3-3) ss_ereusglove012
                 case 71: sItem = "ss_ereusglove012"; break;    // Ereus gloves +10
                 case 72: sItem = "rahlsword"; break;           // RahlSword
                 case 73: sItem = "epicbowofthe"; break;        // EpicBow of the Vampire
                 case 74: sItem = "greaterdeadlys"; break;      // ?????
                 case 75: sItem = "bitch"; break;               // Bitch bow   epicmagicstaff
                 case 76: sItem = "epiclongsworcut"; break;     // Epic Longsword of the cutting edge
                 case 77: sItem = "epiclongsworcut"; break;     // Epicmagicstaff
                 case 78: sItem = "armouroftheblack"; break;    // Armour of the Black
                 case 79: sItem = "blacklongsword"; break;      // Black longsword
                 case 80: sItem = "blackhelmet"; break;         // Black Helmet
                 }
                 dbCreateItemOnObject(sItem, oTarget, 1);
                 }


//-------------------------------end 2nd custom treasure------------------------
