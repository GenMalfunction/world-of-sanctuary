...
//:://////////////////////////////////////////////
/*
    Up to [turn undead] times per day the character may add his Charisma bonus to his magical
    damage resist for a number of rounds equal to the Charisma bonus.
*/
//:://////////////////////////////////////////////
//::04. November by SilverShade
//:://////////////////////////////////////////////
...
void main()
{
   ...
   if(GetHasFeatEffect(414) == FALSE)
   {
        ...
        effect eMag = EffectDamageResistance(DAMAGE_TYPE_MAGICAL, nCharismaBonus);
        effect eLink = EffectLinkEffects(eDur, eMag);
