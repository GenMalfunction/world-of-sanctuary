...
void main()
{
    ...
    {
    GiveXPToCreature (GetLastUnlocked(), 100); // Reward PC, alternatively, if you wish to reward party use PartyGotEntry() and Include cu_functions as with Multiplayer Experience Scripts 2
