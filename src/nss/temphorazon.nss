...
object oSpawn;
location lTarget;
oTarget = GetWaypointByTag("temphorazon");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_PLACEABLE, "kingportal012", lTarget);
...
oTarget = GetWaypointByTag("outhorazon");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_CREATURE, "horazon100", lTarget);
