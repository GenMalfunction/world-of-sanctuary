...
object oSpawn;
location lTarget;
oTarget = GetWaypointByTag("tempbartuc");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_PLACEABLE, "kingportal007", lTarget);
...
oTarget = GetWaypointByTag("outbartuc");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_CREATURE, "bartuc100", lTarget);
