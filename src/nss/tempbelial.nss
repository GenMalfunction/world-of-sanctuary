...
object oSpawn;
location lTarget;
oTarget = GetWaypointByTag("tempbelial");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_PLACEABLE, "kingportal008", lTarget);
...
oTarget = GetWaypointByTag("outbelial");

lTarget = GetLocation(oTarget);

oSpawn = CreateObject(OBJECT_TYPE_CREATURE, "belial100", lTarget);
