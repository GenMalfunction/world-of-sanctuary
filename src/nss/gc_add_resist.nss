...
int nType = GetLocalInt(oPC, "CRAFT_DR_AMOUNT");
int nIPType = GetLocalInt(oPC, "DI_TYPE");

//What we are adding is AC
itemproperty ipAddAC=ItemPropertyDamageResistance(nIPType, nType);

//Remove the Existing FIRST!
IPRemoveMatchingItemProperties(oCraft, ITEM_PROPERTY_DAMAGE_RESISTANCE, DURATION_TYPE_PERMANENT, nIPType);
