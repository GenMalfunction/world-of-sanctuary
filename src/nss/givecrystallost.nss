...
CreateItemOnObject("crystallost", oPC);
SpeakString("Someone found the Crystal of the Lost !", TALKVOLUME_SHOUT);
object oTarget;
object oSpawn;
location lTarget;
oTarget = GetWaypointByTag("nakrul");
lTarget = GetLocation(oTarget);
oSpawn = CreateObject(OBJECT_TYPE_CREATURE, "dreddlord004", lTarget);
oTarget = oSpawn;
