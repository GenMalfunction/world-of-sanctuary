...
int nBonus = GetLocalInt(oPC, "CRAFT_SR_TOTAL");

//What we are adding is AC
itemproperty ipAddAC;


ipAddAC = ItemPropertyBonusSpellResistance(nBonus);

//Remove the Existing FIRST!
IPRemoveMatchingItemProperties(oCraft, ITEM_PROPERTY_SPELL_RESISTANCE, DURATION_TYPE_PERMANENT, -1);
